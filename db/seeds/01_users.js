  ...
  return knex('users').del()
    .then(function () {
      ...
      return knex('users').insert([
        {email: 'user1@yahoo.com', username: 'user1', password: '$2a$10$16HA89xoCCWDZ.Kfjes6vepMaZKYZ106z/b5CTXVnxtO/l8DvEMyi', fname: '', lname: 'luser1', bio: 'Seeking Adventure', age: 24, zipcode: '95011', img_url:"https://s3-eu-west-1.amazonaws.com/video.gallereplay.com/production/user_74/picture_17112016100959.jpg"},
